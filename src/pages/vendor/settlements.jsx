...
import { Banknote, X, Calendar, CreditCard, Building2, CheckCircle, Eye, Hash } from "lucide-react";
...
const Settlements = () => {
  ...
  const DetailRow = ({ label, value }) => (
    <div className="flex justify-between items-center text-sm p-3 bg-white/50 dark:bg-slate-800/50 rounded-lg">
        ...
        >
          ...
          >
            <h1 className="text-4xl font-bold text-slate-900 dark:text-slate-100 mb-2 flex items-center gap-3">
              <div className="p-2 bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900 dark:to-blue-800 rounded-xl">
                <Building2 className="h-8 w-8 text-blue-700 dark:text-blue-300" />
              </div>
              Bank Settlements
            </h1>
            <p className="text-slate-600 dark:text-slate-400 text-lg">
              Track your settlement history and bank transfers.
            </p>
          </motion.div>
          ...
          >
            ...
            {loading ? (
              <div className="flex items-center justify-center py-12">
                ...
                <span className="text-slate-600 dark:text-slate-400">Loading settlements...</span>
              </div>
            ) : error ? (
              ...
              <div className="text-center py-12">
                <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700">
                  ...
                  <p className="text-slate-500 dark:text-slate-400">No settlements found.</p>
                </div>
              </div>
            ) : (
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-slate-600 dark:text-slate-400 mb-4">
                          <p className="flex items-center gap-2">
                            ...
                            <span className="font-medium">Bank Ref:</span> {st.bankReference || "-"}
                          </p>
                        </div>
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400">Settlement Details</p>
              </div>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <div className="grid grid-cols-1 gap-4">
                ...
                <DetailRow label="Status" value={<span className="text-emerald-600 dark:text-emerald-400 font-medium">{selectedSettlement.status || 'SETTLED'}</span>} />
              </div>
            </div>
            ...
            <div className="border-t border-slate-200 dark:border-slate-700 pt-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-2xl font-bold text-slate-900 dark:text-slate-100">₹{selectedSettlement.amount}</span>
              </div>
            </div>
          </motion.div>
        </motion.div>
